...
<div ref={el => { if(el) statsRef.current[0] = el }} className="bg-lime-400 p-6 rounded-xl w-56 text-center">
<h2 className="text-4xl font-bold">58%</h2>
<p>Increase in pick up point use</p>
</div>

<div ref={el => { if(el) statsRef.current[1] = el }} className="bg-gray-800 text-white p-6 rounded-xl w-56 text-center">
...
<img ref={carRef} src="/car.png" className="absolute right-0 w-[500px]" />

<div className="absolute bottom-20 flex gap-6">

<div ref={el => { if(el) statsRef.current[2] = el }} className="bg-sky-400 p-6 rounded-xl w-56 text-center">
<h2 className="text-4xl font-bold">23%</h2>
<p>Decreased in customer phone calls</p>
</div>

<div ref={el => { if(el) statsRef.current[3] = el }} className="bg-orange-500 p-6 rounded-xl w-56 text-center">
